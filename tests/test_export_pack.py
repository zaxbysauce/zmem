...
class ExportPackHelpTests(unittest.TestCase):
    ...
    def test_max_bytes_help_matches_budget_semantics(self):
        ...
        # And the omitted-count note must not be claimed unconditional — it
        # renders only when rows were omitted (swarm-pr-review PRR-002):
        self.assertNotIn("always renders", h)
