...
lesson is the agent's self-opinion and never surfaces in default recall (it is
still reachable via an explicit low `--min-confidence` or keyword search) (#36 M3).
